      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input type="password" id="repassword" name="repassword" required=""> 
            ...
            <option value="teacher">CTSU</option>
            <option value="student">Brunch</option>
            </select><br><br>
            
            <p class="contact"><label for="course">admin/Brunch..</label></p>
            <select class="select-style gender" name="course">
            <option value="coporate brunch">Corporate Brunch(100)</option>
            <option value="norsuth brunch ">northsouth Brunch(017)</option>
            <option value="Basundhora Brunch">basundhara Brunch(023)</option>
            </select><br><br>
